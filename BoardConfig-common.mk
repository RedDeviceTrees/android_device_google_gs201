...
BOARD_PREBUILT_DTBIMAGE_DIR := device/google/pantah-kernel/dtb.img
BOARD_PREBUILT_DTBOIMAGE := device/google/pantah-kernel/dtbo.img
...
BOARD_VENDOR_KERNEL_RAMDISK_KERNEL_MODULES_LOAD := $(strip $(shell cat device/google/pantah-kernel/vendor_kernel_boot.modules.load))
...
BOARD_VENDOR_KERNEL_MODULES_LOAD := $(strip $(shell cat device/google/pantah-kernel/vendor_dlkm.modules.load))
